  ...
  class Debit
    ...
    class << self
      ...
      def bankaccountSet(options = {})
        assert_valid_keys(options, :accessKey, :testMode, :customerId, :iban, :bic, :country, :bankCode, :accountNumber, :accountHolder, :holderAddress,
      ...
      def bankCheck(options = {})
        assert_valid_keys(options, :accessKey, :testMode, :iban, :bic, :country, :bankCode)
      ...
      def bankaccountCheck(options = {})
        assert_valid_keys(options, :accessKey, :testMode, :iban, :bic, :country, :bankCode, :accountNumber)
      ...
      def bankaccountBar(options = {})
        assert_valid_keys(options, :accessKey, :testMode, :iban, :bic, :country, :bankCode, :accountNumber, :barStatus)
      ...
      def addressSet(options = {})
        assert_valid_keys(options, :accessKey, :testMode, :customerId, :firstName, :surName, :company, :street, :zip, :city, :country)
        assert_keys_exists(options, :customerId)
      ...
      def contactDataSet(options = {})
        assert_valid_keys(options, :accessKey, :testMode, :customerId, :email, :phone, :mobile)
        assert_keys_exists(options, :customerId)
      ...
      def sessionCreate(options = {})
        assert_valid_keys(options, :accessKey, :testMode, :customerId, :sessionId, :project, :projectCampaign, :account, :webmasterCampaign,
      ...
      def sessionSet(options = {})
        assert_valid_keys(options, :accessKey, :testMode, :sessionId, :freeParams)
      ...
      def sessionCredit(options = {})
        assert_valid_keys(options, :accessKey, :testMode, :customerId, :sessionId, :amount, :payText)
        #mandateRecur => [ONEOFF, RECURRING, FINAL]
      ...
      def sessionList(options = {})
        assert_valid_keys(options, :accessKey, :testMode, :customerId, :dtmFrom, :dtmTo, :from, :count)
        assert_keys_exists(options, :customerId)
      ...
      def sessionReverseTest(options = {})
        assert_valid_keys(options, :accessKey, :testMode, :sessionId, :reverseCode, :reverseReason)
        assert_keys_exists(options, :sessionId)
      ...
      def sessionRechargeTest(options = {})
        assert_valid_keys(options, :accessKey, :testMode, :sessionId, :amount)
        assert_keys_exists(options, :sessionId)
      ...
      def sessionRefund(options = {})
        assert_valid_keys(options, :accessKey, :testMode, :sessionId, :bankCode, :accountNumber, :accountHolder, :amount, :payText, :iban, :bic, :country)
        assert_keys_exists(options, :sessionId)
      ...
      def transactionCreate(options = {})
        assert_valid_keys(options, :accessKey, :testMode, :sessionId, :date, :amount, :description)
        assert_keys_exists(options, :sessionId, :amount)
